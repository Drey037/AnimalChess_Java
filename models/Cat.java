...
/**
 * The class Cat is used to represent the cat
...
public class Cat extends Animals{
     ...
     * and the trapped status of the Cat class
     *
     * @param x the X position
     * @param y the Y position
     * @param c the boolean value whether the animal is Red or Blue
     */
    public Cat(int x, int y, boolean c) {
        super( 2, x, y, c, false, false);

        if (c == false)
            ImgFile = "/Resources/Blue Cat.png";
        else
            ImgFile = "/Resources/Red Cat.png";
    }
